...
// Source: session/crawler_detector.go
//
// Generated by this command:
//
//	mockgen -copyright_file=.license_header -source=session/crawler_detector.go -package=session -destination=session/provider.mock_test.go Provider
//
