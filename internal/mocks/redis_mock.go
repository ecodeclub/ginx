...
//
//	mockgen.exe -source=G:\go-up\pkg\mod\github.com\redis\go-redis\v9@v9.1.0\commands.go -package=mocks -destination=G:\go-up\src\ginx\internal\mocks\redis_mock.go
//
